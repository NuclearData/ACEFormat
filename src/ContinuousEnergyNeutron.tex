...
\begin{JXSTable}{continuous-energy neutron}
    ...
    32 & \var{IXS}   & Table of particle production locators
...
The \Block{IXS} gives 10 particle production locators for each of the particle types defined in the \Block{PTYPE}. If the \Block{IXS} is present, the \Block{IXS} starts at the index \var{LTYPE} = \jxs{32}. The \Block{IXS} serves a similar function as the \Block{JXS}, in that it provides locators for individual blocks of data.
