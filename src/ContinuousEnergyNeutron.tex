...
\begin{XSSTable}{Order of probability table elements $P(i,j,k)$}
  ...
  \ldots \\
  \var{PTABLE}         & \multirow{2}{*}{$\CDF_{i}(l),l=1,\ldots,M$}              & \multirow{2}{*}{Cumulative probabilities for energy $i$} \\
  +$(i-1)*6M$    &                         & \\
  \ldots \\
  \var{PTABLE}         & \multirow{2}{*}{$H_{N}(l),l=1,\ldots,M$}                 & \multirow{2}{*}{Heating numbers/factors for energy $N$} \\
  \hfill+$(N-1)*6M+5M$ &                         & 
