...
\begin{enumerate}
  \item {\bfseries\sffamily No \Block{NU}.} (\jxs{2}=0)
...
\begin{ThreePartTable}
  ...
  \item[$\ast\ast$] \label{tn:Relativeto} Relative to $\var{JED}+\LOC{C}{i}-1$
  \end{TableNotes}
  \begin{XSSTable}{Format for the secondary energy distribution.}
    \var{JED}+\LOC{C}{i}-1                & \var{LNW}$_{1}$                  & Location of next law.\tnotex{tn:LNW} \tnotex{tn:Relativeto} \\
    \var{JED}+\LOC{C}{i}                  & \var{LAW}$_{1}$                  & Name of this law \\
    \var{JED}+\LOC{C}{i}+1                & \var{IDAT}$_{1}$                 & Location of data for this law\tnotex{tn:Relativeto}  \\
    ...
    \var{JED}+\var{LNW}$_{1}-1$           & \var{LNW}$_{2}$                  & Location of next law\tnotex{tn:Relativeto} \\
