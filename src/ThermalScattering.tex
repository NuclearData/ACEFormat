...
\begin{enumerate}
  ...
  \item \textbf{\Block{ITCE}} and \textbf{\Block{ITCE}}---contains the energy-dependent elastic scattering cross sections.
                                ...
                                (\jxs{4}$\neq0$). The \Block{ITCE2} only exists for mixed mode elastic scattering (\jxs{4}$=5$).
                                See \Sectionref{sec:ITCEBlock}.
  ...
  \item \textbf{\Block{ITCA}} and \textbf{\Block{ITCA2}}---contains angular distributions for elastic scattering.
                                ...
                                (\jxs{4}$\neq0$) and \nxs{6}$\neq-1$. The \Block{ITCE2} only exists for mixed mode elastic
                                scattering (\jxs{4}$=5$) and \nxs{6}$\neq-1$. See \Sectionref{sec:ITCABlock}.
\end{enumerate}
...
\begin{NXSTable}{thermal scattering}
  ...
  5  & \var{IDPNC} & Elastic scattering mode (incoherent=3, coherent=4, mixed=5) \\
...
The format of the \Block{ITCA} is given in \Tableref{tab:ITCABlock}. The index at the start of the block is \startblock{ITCA}=\jxs{6}.
For each incident energy from the \Block{ITCE}, $N_\mu=$\nxs{6}+1 discrete cosines are given.
