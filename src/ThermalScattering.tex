...
\begin{enumerate}
  ...
  \item \textbf{\Block{ITCE}}---contains the energy-dependent elastic scattering cross sections.
                                The \Block{ITCE} exists if the material has coherent or incoherent elastic scattering;
  ...
  \item \textbf{\Block{ITCA}}---contains angular distributions for elastic scattering. The \Block{ITCA} exists if
