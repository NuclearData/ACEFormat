...
\subsubsubsection{\var{LAW}=1---Tabular Equiprobable Energy Bins (From ENDF Law 1)}\label{sec:LAW1}
...
\subsubsubsection{\var{LAW}=4---Continuous Tabular Distribution (From ENDF Law 1)}\label{sec:LAW4}
\subsubsubsection{\var{LAW}=5---General Evaporation Spectrum (From ENDF-6, \MF=5, \var{LF}=5)}\label{sec:LAW5}
\subsubsubsection{\var{LAW}=7---Simple Maxwell Fission Spectrum (From ENDF-6, \MF=5, \var{LF}=7)}\label{sec:LAW7}
\subsubsubsection{\var{LAW}=9---Evaporation Spectrum (From ENDF-6, \MF=5, \var{LF}=9)}\label{sec:LAW9}
\subsubsubsection{\var{LAW}=11---Energy Dependent Watt Spectrum (From ENDF-6, \MF=5, \var{LF}=11)}\label{sec:LAW11}
\subsubsubsection{\var{LAW}=22---Tabular Linear Functions (From UK Law 2)}\label{sec:LAW22}
\subsubsubsection{\var{LAW}=24---(From UK Law 6)}\label{sec:LAW24}
\subsubsubsection{\var{LAW}=44---Kalbach-87 Formalism (From ENDF-6 \MF=6 \var{LAW}=1, \var{LANG}=2)}\label{sec:LAW44}
\subsubsubsection{\var{LAW}=61---Like \var{LAW}=44, but tabular angular distribution instead of Kalbach-87}\label{sec:LAW61}
\subsubsubsection{\var{LAW}=66---$N$-body phase space distribution (From ENDF-6 \MF=6 \var{LAW}=6)}\label{sec:LAW66}
\subsubsubsection{\var{LAW}=67---Laboratory Angle-Energy Law (From ENDF-6 \MF=6 \var{LAW}=7)}\label{sec:LAW67}
