...
\begin{BlockTable}{LDLW}
  \var{LED}             & \var{LOCC}$_{1}$         & Location of energy distribution data for reaction \MT$_{1}$ or group 1 (if delayed neutron) \\
  \var{LED}+1           & \var{LOCC}$_{2}$         & Location of energy distribution data for reaction \MT$_{2}$ or group 2 (if delayed neutron) \\
  \ldots \\
  \var{LED}+\var{NMT}-1 & \var{LOCC}$_{\var{NMT}}$ & Location of energy distribution data for reaction \MT$_{\var{NMT}}$ or group \var{NMT} (if delayed neutron)
  \label{tab:LDLWBlock}
\end{BlockTable}
\begin{tablenotes}
  \note The \var{LOCC}$_{i}$ must be monotonically increasing.
\end{tablenotes}
\end{ThreePartTable}
