...
\begin{BlockTable}{\textnormal{Cross section array for the $i$-th \var{SIG}}}
...
\multirow{2}{*}{\var{LXS} + \var{LOCA}$_{i}$+1} & $\sigma_{i}[E(K)]$                    & \multirow{2}{*}{Cross section for reaction \MT$_{i}$} \\
                               & for $K=IE_{i},\ldots,IE_{i}+NE_{i}-1$ &
